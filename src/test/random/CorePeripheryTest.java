...
public class CorePeripheryTest {
    public static void main(String[]args){
        testDiscreteModel(1000, 100, 0.5, 0.1, 0);
        testDiscreteModel(10_000, 500, 0.5, 0.1, 0);
        testDiscreteModel(20_000, 2000, 0.75, 0.1, 0);

        testContinuousModel(100);
        testContinuousModel(1000);
        testContinuousModel(10_000);
    }
    public static void testDiscreteModel(int n, int nc, double cc, double pc, double pp){
        UndirectedSparseGraph<Node,Edge> graph = discreteModel(n, nc, cc, pc, pp);
